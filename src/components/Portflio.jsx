    ...
    className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-auto">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="p-8">
          ...
          <p className="py-6">
          <span class="font-bold text-xl">On Road Vehicle Breakdown Assistance:</span> This project is a web application that provides a solution for those
          people whose vehicles get a breakdown in remote locations and will help to reduce user time for finding a
          proper mechanic.
          </p>
          <p className="py-6">
          <span class="font-bold text-xl">Cardamom Plant Disease Detection Approach Using EfficientNetV2:</span> Detection and Approach of Cardamom
          Plant Disease using EfficientNetV2 where Deep Learning and Machine Learning algorithms were used.
          </p>
          <p className="py-6">
          <span class="font-bold text-xl">Mood Based Music Recommendation System:</span> This application generates a playlist according to the mood and
          facial expression extracted reducing the effort and time involved in rendering the process manually.
          </p>
        </div>
